...
namespace Bili.Desktop.App.Controls
{
    ...
    public sealed partial class ImageViewer : UserControl
    {
        ...
        private void OnRotateButtonClick(object sender, Microsoft.UI.Xaml.RoutedEventArgs e)
            => RotateTransform.Angle += 90;

        private void OnZoomOutButtonClick(object sender, Microsoft.UI.Xaml.RoutedEventArgs e)
        {
        ...
        private void OnZoomInButtonClick(object sender, Microsoft.UI.Xaml.RoutedEventArgs e)
        {
            if (_currentImageHeight == 0)
            {
                return;
