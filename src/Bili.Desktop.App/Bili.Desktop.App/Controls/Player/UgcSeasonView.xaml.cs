...
namespace Bili.Desktop.App.Controls.Player
{
    ...
    public sealed partial class UgcSeasonView : UgcSeasonViewBase
    {
        ...
        private void OnSeasonComboBoxSelectionChanged(object sender, Microsoft.UI.Xaml.Controls.SelectionChangedEventArgs e)
        {
        ...
        private async void OnRepeaterLoadedAsync(object sender, Microsoft.UI.Xaml.RoutedEventArgs e)
        {
