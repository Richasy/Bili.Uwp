...
namespace Bili.ViewModels.Interfaces.Core
{
    ...
    public interface INavigationViewModel : IReactiveObject
    {
        ...
        void NavigateToPlayView(IEnumerable<VideoInformation> parameters, int startIndex = 0);
