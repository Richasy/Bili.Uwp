...
namespace Bili.ViewModels.Desktop.Core
{
    ...
    public sealed partial class MediaPlayerViewModel : ViewModelBase, IMediaPlayerViewModel
    {
            ...
            IAppViewModel appViewModel)
        {
            ...
            ForwardSkipCommand = new RelayCommand(ForwardSkip);
            BackwardSkipCommand = new RelayCommand(BackwardSkip);
            ChangePlayRateCommand = new RelayCommand<double>(ChangePlayRate);
            ...
            StartTempQuickPlayCommand = new RelayCommand(StartTempQuickPlay);
            StopTempQuickPlayCommand = new RelayCommand(StopTempQuickPlay);
        ...
        partial void OnDisplayModeChanged(PlayerDisplayMode value)
        {
            ...
            {
                _navigationViewModel.AddBackStack(Models.Enums.App.BackBehavior.PlayerModeChange, _ =>
                {
                    _dispatcherQueue.TryEnqueue(DispatcherQueuePriority.Normal, () =>
                    {
        ...
        partial void OnIsShowMediaTransportChanged(bool value)
        {
            if (_appViewModel.IsXbox)
            {
                ...
                if (value)
                {
                    _navigationViewModel.AddBackStack(Models.Enums.App.BackBehavior.PlayerPopupShown, _ =>
                    {
                        _dispatcherQueue.TryEnqueue(DispatcherQueuePriority.Normal, () =>
                        {
