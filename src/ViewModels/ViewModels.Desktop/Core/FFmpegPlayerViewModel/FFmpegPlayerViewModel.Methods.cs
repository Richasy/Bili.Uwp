...
namespace Bili.ViewModels.Desktop.Core
{
    ...
    public sealed partial class FFmpegPlayerViewModel
    {
        ...
        private void Clear()
        {
            ...
            if (_videoCurrentSession != null)
            {
                _videoCurrentSession.PositionChanged -= OnPlayerPositionChanged;
            }
            ...
            if (_videoPlayer != null)
            {
                ...
                _videoPlayer.CurrentStateChanged -= OnMediaPlayerCurrentStateChanged;
                _videoPlayer.MediaEnded -= OnMediaPlayerEnded;
                _videoPlayer.MediaFailed -= OnMediaPlayerFailed;
            }

            if (_audioPlayer != null)
            {
                _audioPlayer.MediaFailed -= OnMediaPlayerFailed;
            }
