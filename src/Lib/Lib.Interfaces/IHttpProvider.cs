...
namespace Richasy.Bili.Lib.Interfaces
{
    ...
    public interface IHttpProvider
    {
        ...
        HttpRequestMessage GetRequestMessage(HttpMethod method, string url, Dictionary<string, object> queryParams = null, RequestClientType type = RequestClientType.Android);
