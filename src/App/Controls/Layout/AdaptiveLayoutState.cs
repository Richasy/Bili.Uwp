...
namespace Richasy.Bili.App.Controls
{
    ...
    /// 自适应布局状态管理.
    /// </summary>
    public class AdaptiveLayoutState
    {
        ...
        internal void EnsureElementSize(
            ...
            AdaptiveLayoutItemsStretch stretch,
            ...
            int maxItemsPerLine)
        {
            ...
            if (stretch == AdaptiveLayoutItemsStretch.Fill)
            {
            ...
            else if (stretch == AdaptiveLayoutItemsStretch.Uniform)
            {
